 ...
 * The IR API provides the way to get the information whether IR is available, available carrier frequency list and transmit IR command.
 * @section CAPI_SYSTEM_DEVICE_IR_MODULE_FEATURE Related Features
 * This API is related with the following feature:\n
 *  - http://tizen.org/feature/ir\n
 *
 * It is recommended to design feature related codes in your application for reliability.\n
 *
 * You can check if a device supports the related features for this API by using @ref CAPI_SYSTEM_SYSTEM_INFO_MODULE, thereby controlling the procedure of your application.\n
