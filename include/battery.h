...
typedef enum {
	...
	DEVICE_BATTERY_HEALTH_UNSPECIFIED_FAILURE, /**< Unspecified failure occurred during getting the battery health information */
 ...
 */
typedef enum {
	DEVICE_BATTERY_PROPERTY_CAPACITY,       /**< The battery capacity */
	DEVICE_BATTERY_PROPERTY_CURRENT_NOW,    /**< The battery current */
	DEVICE_BATTERY_PROPERTY_CURRENT_AVERAGE,/**< The average battery current */
